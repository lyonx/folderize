...
class Page extends Component {
   ...
   initSortable() {
      ...
      let plugins = new buildfire.components.pluginInstance.sortableList(selector, [], { showIcon: true, confirmDeleteItem: false }, undefined, undefined, { itemEditable: true, navigationCallback: () => console.log("nav cb") });
      ...
      this.props.data.images.forEach(image => {
         images.push(
            <div className="image-wrap">
               <div className="images" style={`background: ${image}`} />
            </div>
         );
         return images;
      });
